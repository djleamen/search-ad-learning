...
const taxonomy = {
  ...
  "/Hobbies & Leisure": {
    tags: ["camping gear", "trail maps", "drone photography", "collectible antiques", "woodworking tools", "fishing reels","golf clubs", "birdwatching lenses", "board game nights", "craft supplies", "pottery class"],
...
function getOrCreateUserId() {
    /**
     * Get a stable user ID for this browser profile.
     * @returns {string}
     */
    const storageKey = "searchAdLearningUserId";
...
function buildAuthHeaders(extraHeaders = {}) {
    /**
     * Build request headers containing stable user identity.
